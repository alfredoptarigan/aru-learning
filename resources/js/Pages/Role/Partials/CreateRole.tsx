                ...
                <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg border-2 border-black p-6">
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="space-y-2 max-w-md">
                            <Label htmlFor="name" className="text-lg font-vt323">Role Name</Label>
                            <Input
                                id="name"
                                value={data.name}
                        ...
                        <div className="space-y-4">
                            <Label className="text-lg font-vt323">Assign Permissions</Label>
                            
                            {permissions.length === 0 && (
                                <p className="text-gray-500 font-vt323">No permissions available. Create some first.</p>
                            )}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {Object.entries(groupedPermissions).map(([groupName, groupPerms]) => {
                                    ...
                                    return (
                                        <div key={groupName} className="border-2 border-black p-4 rounded-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] bg-gray-50">
                                            <div className="flex items-center justify-between mb-4 border-b-2 border-gray-200 pb-2">
                                                <h3 className="font-bold text-lg font-vt323 uppercase">{groupName}</h3>
                                                <div className="flex items-center space-x-2">
                                                    ...
                                                    />
                                                    <label htmlFor={`group-${groupName}`} className="text-xs font-vt323 cursor-pointer text-gray-500">
                                                        Select All
                                                    </label>
                                                </div>
                                            </div>
                        ...
                        <div className="flex items-center gap-4">
                            <Link href={route('role.index')}>
                                <Button type="button" variant="secondary" className="font-vt323 text-lg border-2 border-black">
                                    Cancel
                                </Button>
                            </Link>
                            <Button
